        ...
        for transaction in transactions_list:
            ...
            if credit:
                ...
                for temp_account in getattr(journal_entry, "accounts", list()):
                    if account == temp_account.account \
                            and temp_account.credit \
                            and credit \
                            and temp_account.cost_center == cost_center \
                            and temp_account.journal_note == _statement:
