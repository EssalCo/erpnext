...
def execute():
        ...
        for row in spamreader:
            ...
            journal_entry = frappe.get_doc(
                dict(
                    ...
                    user_remark=remark,
                    multi_currency=0,
                    remark="CHEQNO: {0}, BANK: {1}, REMARK: {2}, PAY_NAME: {3}, RCP_NO: {4}".format(cheq, bank, remark, pay_name, receipt_no),
    ...
    #         parent_account = row[10].decode('utf-8') if row[10] else None
    #
    #         if parent_account:
            ...
            if serial_no != current_entry_index:
                ...
                journal_entry = frappe.get_doc(
                    dict(
                        ...
                        accounts=[],
                        is_opening="Yes" if serial_no == 1 else "No"
                    )
                )
